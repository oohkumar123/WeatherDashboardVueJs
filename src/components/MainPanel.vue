                                    ...
                                    <div class="col-lg-8 d-flex flex-column">
                                        <div class="row flex-grow">
                                            <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                                                <PerformanceLineChart :salesData="salesData" :key="componentKey"></PerformanceLineChart>
...
export default {
    ...
    methods: {
        dataUpdate () {
            ...
            fetch("https://api.openweathermap.org/data/3.0/onecall?lat=37.9060&lon=122.5450&appid=8362d7576fff036a08554d81480c7689")
            ...
            .then((data) => {
                ...
                this.salesData.labels = this.week;
                this.salesData.thisWeek.data = thisWeekData;
                this.salesData.lastWeek.data = lastWeekData;
                this.componentKey++;
            })
            .catch((error) => {
